...
/**void(^)(NSInteger)*/
typedef void(^KBIntegerBlock)(NSInteger inte);
/**void(^)(NSString)*/
...
typedef void(^KBIntegerStringBlock)(NSInteger inte, NSString * _Nullable str);
/**void(^)(NSIntege,NSNumberr)*/
typedef void(^KBIntegerNumberBlock)(NSInteger inte, NSNumber * _Nullable num);
/**void(^)(NSInteger,NSData)*/
typedef void(^KBIntegerDataBlock)(NSInteger inte, NSData * _Nullable dat);
/**void(^)(NSInteger,NSArray)*/
typedef void(^KBIntegerArrayBlock)(NSInteger inte, NSArray * _Nullable arr);
/**void(^)(NSInteger,NSDictionary)*/
typedef void(^KBIntegerDictionaryBlock)(NSInteger inte, NSDictionary * _Nullable dic);


/**void(^)(NSString,NSString)*/
typedef void(^KBStringResultBlock)(NSString * _Nullable str, NSString * _Nullable message);
/**void(^)(NSNumber,NSString)*/
typedef void(^KBNumberResultBlock)(NSNumber * _Nullable num, NSString * _Nullable message);
/**void(^)(NSData,NSString)*/
typedef void(^KBDataResultBlock)(NSData * _Nullable dat, NSString * _Nullable message);
/**void(^)(NSArray,NSString)*/
typedef void(^KBArrayResultBlock)(NSArray * _Nullable arr, NSString * _Nullable message);
/**void(^)(NSDictionary,NSString)*/
typedef void(^KBDictionaryResultBlock)(NSDictionary * _Nullable dic, NSString * _Nullable message);
/**void(^)(id,NSString)*/
typedef void(^KBAnyResultBlock)(id _Nullable obj, NSString * _Nullable message);
